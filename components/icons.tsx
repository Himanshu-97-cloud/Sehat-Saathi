...
export const StethoscopeIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.5 10.5c-3.22.54-5.62 2-5.62 4.5v2h2.12" /><path d="M9 12.11V6.5a2.5 2.5 0 0 1 5 0v5.61" /><path d="M14.5 10.5c3.22.54 5.62 2 5.62 4.5v2h-2.12" /><path d="M12 12.11h.01" /><path d="M9 18.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" /><path d="M19 18.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" /></svg>
);

export const SirenIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 12 6-6" /><path d="m6 6 6 6" /><path d="M12 22a7 7 0 0 0 7-7h-4a3 3 0 0 1-6 0H5a7 7 0 0 0 7 7Z" /><path d="M12 8a3 3 0 0 0-3-3H5a7 7 0 0 1 7-2 7 7 0 0 1 7 2h-4a3 3 0 0 0-3 3Z" /></svg>
);
